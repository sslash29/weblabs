...
class Request:
    def __init__(self, method, path, query, headers, cookies, body_bytes):
        ...
        self.headers = headers  # case-insensitive-ish dict (lowercased keys)
...
class Handler(BaseHTTPRequestHandler):
    server_version = "NovaFreightServer/1.0"
    protocol_version = "HTTP/1.1"

    def log_message(self, fmt, *args):
        pass  # keep console quiet; access not needed for the lab
    ...
    def _dispatch(self, method):
        ...
        # exact (param-less) routes take priority over parameterized ones,
        # so e.g. /support/download isn't shadowed by /support/<ticket_id>
            ...
            try:
                ...
                if config.DEBUG:
                    ...
                    body = (
                        ...
                        "<p>DEBUG=True — showing traceback (disable in production).</p>"
...
def run():
    ...
    print(f"NovaFreight lab running at http://{config.HOST}:{config.PORT}")
    try:
